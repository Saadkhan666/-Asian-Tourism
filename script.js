...
const countries = [
  { 
    name: "Saudi Arabia", 
    attractions: ["Kaaba", "Masjid-e-Nabwi", "Historic Jeddah"], 
    image: "https://example.com/images/kaaba.jpg" 
  },
  { 
    name: "Japan", 
    attractions: ["Mount Fuji", "Tokyo Tower", "Cherry Blossoms"], 
    image: "https://example.com/images/japan.jpg" 
  },
  { 
    name: "India", 
    attractions: ["Taj Mahal", "Jaipur", "Kerala Backwaters"], 
    image: "https://example.com/images/india.jpg" 
  },
  { 
    name: "Thailand", 
    attractions: ["Phuket Beaches", "Floating Markets", "Grand Palace"], 
  ...
  { 
    name: "Indonesia", 
    attractions: ["Bali", "Borobudur Temple", "Komodo Island"], 
